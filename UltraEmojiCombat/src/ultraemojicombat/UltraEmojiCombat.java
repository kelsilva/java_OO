...
public class UltraEmojiCombat {
    ...
    public static void main(String[] args) {
        ...
        Lutador l[] = new Lutador[6];
             ...
             l[1] = new Lutador("Putstript","Brazil",29,1.68f,57.8f,14,2,3);
             
             
             l[2] = new Lutador("SnapShadown","EUA",35,1.65f,80.9f,12,2,1);
            
              
             l[3] = new Lutador("DeatCode","Australia",28,1.93f,81.6f,13,0,2);
             
             
             l[4] = new Lutador("UFO cobol","Brasil",37,1.70f,119.3f,5,4,3);
          
             
             l[5] = new Lutador("NEDART","EUA",30,1.81f,105.7f,12,2,4);
             l[5].status();
